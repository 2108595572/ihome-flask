...
def get_house_index():
    ...
    if ret:
        ...
        return '{"errno":0, "errmsg":"OK", "data":%s}' % bytes.decode(ret), 200, {"Content-Type": "application/json"}
    else:
        try:
...
def get_house_detail(house_id):
    ...
    if ret:
        ...
        return '{"errno":"0", "errmsg":"OK", "data":{"user_id":%s, "house":%s}}' % (user_id, bytes.decode(ret)), \
